...
fail("demog_all_n", 37, dem_all$N[1], tol = 0)
fail("demog_all_mean_age", 29.68, dem_all$mean_age[1], tol = 0.01)
fail("demog_all_sd_age", 3.21, dem_all$sd_age[1], tol = 0.01)
fail("demog_all_male", 16, dem_all$gender_1[1], tol = 0)
fail("demog_all_female", 21, dem_all$gender_2[1], tol = 0)
fail("demog_both_n", 33, dem_both$N[1], tol = 0)
fail("demog_both_mean_age", 30.09, dem_both$mean_age[1], tol = 0.01)
fail("demog_both_sd_age", 3.09, dem_both$sd_age[1], tol = 0.01)
fail("demog_both_male", 15, dem_both$gender_1[1], tol = 0)
fail("demog_both_female", 18, dem_both$gender_2[1], tol = 0)

# --- Demographics: mean weight 61.6 ± 9.4 kg among participants with available weight data ---
