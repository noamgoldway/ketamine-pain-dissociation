...
.PHONY: all main supplementary verify check supp-tables supp-figures dose-equiv supp-fig-s2 sync-s5
...
supp-figures: dose-equiv supp-fig-s2
...
sync-s5:
	...
	@mkdir -p output/supplementary/tables
...
check: verify
	...
	@test -f output/supplementary/figures/Supplementary_Figure_S3_connectivity.png
